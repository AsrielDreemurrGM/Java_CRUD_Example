...
public class ClientSetDAO extends GenericSetDAO<Client> implements IClientDAO {
	 ...
	 * @return {@code true} if the entity was added successfully; {@code false} if it was already present.
	 */
	@Override
	...
	/**
	 * Deletes an entity identified by the given value (usually a CPF or product code).
	 * 
	 ...
	 * <p>
	 * If the entity is found, its data will be updated using {@link #updateRegisteredEntityWithNewData(Object, Object)}.
	 * 
	 ...
	 * 
	 * @return a collection containing all stored entities; empty if none are present.
	 */
	@Override
